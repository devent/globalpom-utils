...
/**
 * Event when a list item was changed.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.9
 */
@SuppressWarnings("serial")
public class ListItemChangedEvent extends ListPropertyChangeEvent {
     ...
     */
    public ListItemChangedEvent(Object source, String propertyName, int index0, int index1, Object oldValue,
            Object newValue) {
