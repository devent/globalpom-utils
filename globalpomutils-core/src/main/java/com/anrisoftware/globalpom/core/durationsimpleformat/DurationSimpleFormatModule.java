...
public class DurationSimpleFormatModule extends AbstractModule {
    ...
    private static class InjectorInstance {
        ...
        static final DurationSimpleFormatFactory factory = injector.getInstance(DurationSimpleFormatFactory.class);
    }

    @Override
    protected void configure() {
        install(new FactoryModuleBuilder().implement(DurationSimpleFormat.class, DurationSimpleFormat.class)
                .build(DurationSimpleFormatFactory.class));
    }
