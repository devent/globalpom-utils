...
public class PointFormat extends Format {
    ...
    /**
     * Uses the default decimal format to format the X and Y coordinates of a point.
     */
    public PointFormat() {
     ...
     * Uses the default decimal format to format the X and Y coordinates of a point.
     *
     * @param logger the {@link PointFormatLogger} for logging messages.
     */
    @AssistedInject
    ...
    private Point2D parsePoint(String string, Point2D point) throws ParseException {
        if (point == null) {
