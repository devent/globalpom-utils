...
public abstract class ListPropertyChangeEvent extends PropertyChangeEvent {
    ...
    /**
     * @see PropertyChangeEvent#PropertyChangeEvent(Object, String, Object, Object)
     *
     ...
     */
    public ListPropertyChangeEvent(Object source, String propertyName, int index0, int index1, Object oldValue,
            Object newValue) {
