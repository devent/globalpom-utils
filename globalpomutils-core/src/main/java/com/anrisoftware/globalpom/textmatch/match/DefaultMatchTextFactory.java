 ...
 * @since 2.0
 */
public interface DefaultMatchTextFactory {
     ...
     * 
     * @return the {@link DefaultMatchText}.
     */
    DefaultMatchText create(File file, Pattern pattern, Charset charset);
     ...
     */
    DefaultMatchText create(URL resource, Pattern pattern, Charset charset)
            throws URISyntaxException;
     ...
     * @return the {@link DefaultMatchText}.
     */
    DefaultMatchText create(URI resource, Pattern pattern, Charset charset);
}
