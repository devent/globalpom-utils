...
public class DefaultMatchText implements Serializable {
     ...
     */
    @AssistedInject
    DefaultMatchText(@Assisted File file, @Assisted Pattern pattern,
     ...
     */
    @AssistedInject
    DefaultMatchText(@Assisted URL resource, @Assisted Pattern pattern,
     ...
     */
    @AssistedInject
    DefaultMatchText(@Assisted URI resource, @Assisted Pattern pattern,
            @Assisted Charset charset) {
