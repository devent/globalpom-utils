...
public class DefaultTokensTemplate implements Serializable {
    ...
    @Inject
    private DefaultTokensTemplateLogger log;
     ...
     */
    @Inject
    DefaultTokensTemplate(@Assisted TokenMarker tokenMarker,
     ...
     * 
     * @return this {@link DefaultTokensTemplate}.
     */
    public DefaultTokensTemplate replace() {
        Matcher matcher;
