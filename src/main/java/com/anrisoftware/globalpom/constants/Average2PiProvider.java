...
/**
 * Provides the value of 2Pi {@code 2π≈6.2831853} that calculates error
 ...
 */
@Singleton
public class Average2PiProvider implements Provider<Value> {
