...
/**
 * Provides the value of the absolute zero {@code T→0=-273.15 °C} that
 ...
 */
@Singleton
public class AverageAbsoluteZeroProvider implements Provider<Value> {
