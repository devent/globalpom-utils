...
public final class MatrixDataOps {
     ...
     *
     * @param dataFactory  the {@link MatrixDataFactory}.
     *
     * @param source       the {@link Data} source.
     *
     ...
     */
    public static Data copy(MatrixDataFactory dataFactory, Data source, int rowOffset, int rows, int columnOffset,
            int columns) {
