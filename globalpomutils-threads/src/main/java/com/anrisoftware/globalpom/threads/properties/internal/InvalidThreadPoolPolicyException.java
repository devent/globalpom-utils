...
public class InvalidThreadPoolPolicyException extends ThreadsException {

    public InvalidThreadPoolPolicyException(ThreadingPolicy policy) {
        super("Invalid thread pool policy");
        addContextValue("policy", policy);
    }
