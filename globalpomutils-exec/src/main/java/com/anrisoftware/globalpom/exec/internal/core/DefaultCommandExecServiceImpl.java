 ...
 * @since 3.1
 */
@Component(service = CommandExecService.class)
    ...
    protected void start() {
        createInjector(new DefaultProcessModule(), new AbstractModule() {
            ...
            protected void configure() {
                bind(PipeCommandOutputFactory.class).toProvider(of(commandOutputService));
                bind(PipeCommandInputFactory.class).toProvider(of(commandInputService));
            }
        }).injectMembers(this);
    }
