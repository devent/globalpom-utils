...
import com.anrisoftware.globalpom.exec.external.logoutputs.TraceLogCommandOutputService;

/**
 * Trace level logging service.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 3.1
 */
@Component(service = TraceLogCommandOutputService.class)
public class TraceLogCommandOutputServiceImpl implements TraceLogCommandOutputService {

    @Inject
    private TraceLogCommandOutputFactory factory;
