...
class LatLongFormatTest {
	...
	void "format latitude"() {
		formats.each {
			def format = createLatitudeFormat it.value, format
	...
	void "format longitude"() {
		formats.each {
			def format = createLongitudeFormat it.value, format
			def str = format.format it.value
	...
	void "parse latitude"() {
		parses.each {
			def format = createLatitudeFormat it.value, it.decimal, format
	...
	void "parse longitude"() {
		parses.each {
			def format = createLongitudeFormat it.value, it.decimal, format
