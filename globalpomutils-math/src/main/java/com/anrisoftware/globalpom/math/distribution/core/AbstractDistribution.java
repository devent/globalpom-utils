...
public abstract class AbstractDistribution implements Distribution {
     ...
     *
     * @param range the {@link DistributionRange} range of the valid values of the
     *              distribution.
     *
     * @param bins  the count of classes.
     */
    ...
    public String toString() {
        return new ToStringBuilder(this).append(BINS_FIELD, size).append(RANGE_FIELD, range).toString();
    }
